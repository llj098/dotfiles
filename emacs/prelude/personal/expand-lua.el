;;; lua-mode-expansions.el --- Lua-specific expansions for expand-region

;; Copyright (C) 2014 Lijin Liu

;; Author: Lijin Liu <llj098@gmail.com>
...
(defun er/lua-block-regexp() "do\|if\|function")
