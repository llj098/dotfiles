...
User configuration for the Omarchy deployment. The repository manifests deploy directory trees through `./install.sh`.
...
`minimal-emacs.d/` contains the personal overlay for an upstream
